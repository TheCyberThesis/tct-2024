...
async function connectToDatabase() {
    try {
        ...
        usersCollection = database.collection('users'); // Replace with your collection name
    } catch (err) {
...
app.post('/recover', async (req, res) => {
    ...
    const reset_jwt_key = '1e42a9fe7ea098cc3c42c258c01da812819032fd77221d4efe8f459dc0248e6e';
