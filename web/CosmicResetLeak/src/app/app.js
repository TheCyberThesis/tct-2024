...
const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: 'mbbcok@gmail.com',
        pass: 'cpth ujqk oatd axkt'
    }
});

const jwtSecretKey = '6af667723f1f7f69d6663242498edc67bf590e3eda1a59558cd330fbbc545b92';

const csrfProtection = csrf({ cookie: true });

const sessionMiddleware = session({
    key: 'session_cookie_name',
    secret: '8db15a8aa7c4ed3cf74e7eece5302134bd09417c400287c7f1acab9347c78fc0',
    resave: false,
...
async function connectToDatabase() {
    try {
        ...
        usersCollection = database.collection('Bounty'); 
    } catch (err) {
...
app.post('/recover', async (req, res) => {
    ...
    const reset_jwt_key = 'MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQgofYVrV6I5TvcM1Gc';
...
app.get('/jwt-flag', ensureAdmin, (req, res) => {
    res.render('flag');
});
